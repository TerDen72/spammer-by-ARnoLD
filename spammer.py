...
def main():
  ...
  if choose == '2':
    ...
    if os.name == 'nt':
      ...
      os.system('cls' if os.name=='nt' else 'clear')
      print (logo)
      os.system("cd && rm -rf ~/spammer-by-ARnoLD && git clone https://github.com/palkamilka/spammer-by-ARnoLD && cd spammer-by-ARnoLD && python install.py && cd && cd spammer-by-ARnoLD && python spammer.py")
  else:
    os.system('cls' if os.name=='nt' else 'clear')
    print (logo)
    print ('[!] Ошибка! Повтори запрос!')

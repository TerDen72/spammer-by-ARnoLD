...
while (1 > 0):
  ...
  if choose == '2':
    ...
    os.system("cd && rm -rf ~/spammer-by-ARnoLD && git clone https://github.com/palkamilka/spammer-by-ARnoLD && python ~/spammer-by-ARnoLD/install.py && python ~/spammer-by-ARnoLD/spammer.py")
